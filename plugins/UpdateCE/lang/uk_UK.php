...
# Backup option
	'lang_Backup_Option'		=>	'Створити резервну копію перед оновленням',
	'lang_Backup_Info'			=>	'Перед початком оновлення повну резервну копію сайту буде збережено в backups/zip/.',
	'lang_Backup_Success'		=>	'Резервну копію успішно створено:',
	'lang_Backup_Failed'		=>	'Не вдалося створити резервну копію:',
	'lang_Backup_Aborted'		=>	'Оновлення перервано з міркувань безпеки. Усуньте проблему з резервним копіюванням і спробуйте ще раз або повторіть спробу без параметра резервного копіювання.',
	
# Progress bar
	'lang_Progress_Backup'		=>	'💾 Створення резервної копії...',
	'lang_Progress_Downloading'	=>	'📥 Завантаження оновлення...',
	'lang_Progress_Extracting'	=>	'📦 Розпакування файлів...',
	'lang_Progress_Installing'	=>	'⚙️ Встановлення оновлення...',
	'lang_Progress_Finishing'	=>	'🧹 Завершення...',
	'lang_Progress_Complete'	=>	'Оновлення завершено! Виконується перенаправлення...',
	'lang_Update_Failed'		=>	'Не вдалося виконати оновлення:',
	'lang_Reload_Page'			=>	'Перезавантажити цю сторінку',
