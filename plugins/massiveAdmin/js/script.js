...
if(document.querySelector('body#upload')!==null){
	...
	const h5 = document.querySelector('.h5.clearfix');
	...
	zoomer.style.right = "10px";

	const zoomin = document.createElement('button');
	const zoomout = document.createElement('button');

	zoomin.style.marginRight = '5px';
	zoomin.style.background = "var(--main-color)";
	zoomin.style.border = "var(--main-color)";
	zoomout.style.background = "var(--main-color)";
	zoomout.style.border = "var(--main-color)";
