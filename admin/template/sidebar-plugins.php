...
<ul class="snav">
	...
	<li id="sb_extend" ><a href="https://getsimple-ce.ovh/ce-plugins/" target="_blank" accesskey="<?php echo find_accesskey(i18n_r('GET_PLUGINS_LINK'));?>" ><?php i18n('GET_PLUGINS_LINK'); ?></a></li>
</ul>