...
?>
	...
	<style>
		#maincontent .main, #maincontent .updated, #setup .error {border: 2px solid #cf3805;
		...
		.updated {border-radius:5px; margin-bottom: 15px !important; padding:15px !important;}
		.updated span,b {color:#cf3805; font-weight:600;}
		body{
...
<div class="wrapper">
	<div id="maincontent">
		<?php
			...
			if ($status == 'success') {
				echo '<div class="updated">'. i18n_r('NOTE_REGISTRATION') .' <span>'. $_POST['email'] .'</span></div>';
			}
			elseif ($status == 'error') {
