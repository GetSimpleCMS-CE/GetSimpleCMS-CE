...
$i18n = [
	...
	"SECURITY"				=>	"Security",
	"HTACCESS_TEST_EXPLANATION"	=>	"This test verifies that sensitive directories are actually protected by attempting to access them via HTTP. This ensures .htaccess files are working correctly.",
	"CRITICAL_SECURITY_RISK"	=>	"CRITICAL SECURITY RISK",
	"CANNOT_VERIFY"			=>	"Cannot Verify",
	"CANNOT_TEST"			=>	"Cannot Test",
	"APPLICATION_LEVEL_PROTECTION"	=>	"Application-Level Protection (index.php)",
	"DEFENSE_IN_DEPTH" 		=>	"Defense-in-Depth",
	"INDEX_PHP_EXPLANATION"	=>	"These protection files provide application-level security that works even if .htaccess is disabled. This is your primary defense against unauthorized access.",
	"INDEX_PHP_RECOMMENDATION"	=>	"Place index.php protection files in sensitive directories for defense-in-depth security",
	"RECOMMENDATION"		=>	"Recommendation",
	"CRITICAL"				=>	"CRITICAL",
	"EFFECTIVENESS"			=>	"Effectiveness",
	"PLACE_INDEX"			=>	"Place the provided index.php files in",
	"FILES_PROVIDE"			=>	"These files provide defense-in-depth protection even if .htaccess fails.",
