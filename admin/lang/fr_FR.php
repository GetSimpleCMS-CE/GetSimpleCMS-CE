...
$i18n = [
	...
	"SECURITY"				=>	"Sécurité",
	"HTACCESS_TEST_EXPLANATION"	=>	"Ce test vérifie que les répertoires sensibles sont réellement protégés en tentant d’y accéder via HTTP. Cela garantit que les fichiers .htaccess fonctionnent correctement.",
	"CRITICAL_SECURITY_RISK"	=>	"RISQUE DE SÉCURITÉ CRITIQUE",
	"CANNOT_VERIFY"			=>	"Impossible de vérifier",
	"CANNOT_TEST"			=>	"Impossible de tester",
	"APPLICATION_LEVEL_PROTECTION"	=>	"Protection au niveau de l’application (index.php)",
	"DEFENSE_IN_DEPTH" 		=>	"Défense en profondeur",
	"INDEX_PHP_EXPLANATION"	=>	"Ces fichiers de protection assurent une sécurité au niveau de l’application qui fonctionne même si .htaccess est désactivé. Il s’agit de votre principale défense contre les accès non autorisés.",
	"INDEX_PHP_RECOMMENDATION"	=>	"Placez les fichiers de protection index.php dans les répertoires sensibles pour une défense en profondeur",
	"RECOMMENDATION"		=>	"Recommandation",
	"CRITICAL"				=>	"CRITIQUE",
	"EFFECTIVENESS"			=>	"Efficacité",
	"PLACE_INDEX"			=>	"Placez les fichiers index.php fournis dans",
	"FILES_PROVIDE"			=>	"Ces fichiers assurent une protection en profondeur même si .htaccess échoue.",
