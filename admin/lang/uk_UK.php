...
$i18n = [
	...
	***********************************************************************************/
	...
	// SMTP settings
	"SMTP_OPTIONAL"				=> "Надсилання електронної пошти (необов’язково)",
	"SMTP_SETUP_DESC"			=> "Налаштуйте SMTP зараз, щоб використовувати його для листа підтвердження встановлення та всіх майбутніх листів. Ви також можете ввімкнути його пізніше в Налаштуваннях.",
	
	"SMTP_SETTINGS"				=> "Електронна пошта / SMTP",
	"SMTP_SETTINGS_DESC"		=> "Налаштуйте SMTP для вихідної пошти. Залиште вимкненим, щоб використовувати стандартну функцію PHP mail() сервера.",
	
	"SMTP_ENABLE"				=> "Увімкнути SMTP",
	...
	"SMTP_PASS_PLACEHOLDER"		=> "(без змін)",
	"SMTP_FROM_EMAIL"			=> "E-mail відправника",
	"SMTP_FROM_NAME"			=> "Ім’я відправника",
	"SMTP_TEST_LABEL"			=> "Перевірити з’єднання",
	"SMTP_TEST_BTN"				=> "Надіслати тестовий лист",
	"SMTP_TEST_SENDING"			=> "Надсилання...",
	
	"SMTP_VERIFY_PEER"			=> "Перевіряти SSL-сертифікат",
	"SMTP_VERIFY_PEER_DESC"		=> "Вимикайте лише для локальної розробки з самопідписаними сертифікатами. На робочих серверах завжди залишайте увімкненим.",
	
	"SMTP_TEST_ERROR"			=> "Помилка запиту",
	"SMTP_TEST_ERROR_CSRF"		=> "Перевірка безпеки не пройшла. Перезавантажте сторінку та спробуйте ще раз.",
	"SMTP_TEST_NOT_CONFIGURED"	=> "SMTP не ввімкнено. Спочатку збережіть налаштування.",
	"SMTP_TEST_NO_RECIPIENT"	=> "Для вашого облікового запису не знайдено дійсної електронної адреси.",
	"SMTP_TEST_SUBJECT"			=> "Тест SMTP GetSimple CMS CE",
	"SMTP_TEST_BODY"			=> "Це тестовий лист від GetSimple CMS CE. <br>Якщо ви його отримали, ваші налаштування SMTP працюють правильно.",
	"SMTP_TEST_SUCCESS"			=> "Тестовий лист надіслано на %s",
	"SMTP_TEST_FAILED"			=> "Не вдалося надіслати лист. Перевірте налагоджувальний вивід нижче для отримання подробиць.",
