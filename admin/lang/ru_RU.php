...
"API_CONFIRM" 			=> "ВЫ УВЕРЕНЫ?",
	...
	"Click_the_link"            => "Нажмите на ссылку ниже, чтобы установить новый пароль.",
	"This_link_expires"         => "Срок действия этой ссылки истекает через 1 час, и её можно использовать только один раз.",

	"Reset_link_expired"        => "Срок действия ссылки для сброса пароля истёк. Пожалуйста, запросите новую.",
	"Invalid_already_used"      => "Недействительная или уже использованная ссылка для сброса пароля.",
	"must_be_8_characters"      => "Пароль должен содержать не менее 8 символов.",
	"Passwords_do_not_match"    => "Пароли не совпадают.",
	"Enter_and_confirm"         => "Введите и подтвердите новый пароль.",
	"New_Password"              => "Новый пароль",
	...
	// SMTP settings
	"SMTP_OPTIONAL"				=> "Отправка электронной почты (необязательно)",
	"SMTP_SETUP_DESC"			=> "Настройте SMTP сейчас, чтобы использовать его для письма подтверждения установки и всех будущих писем. Вы также можете включить его позже в разделе Настройки.",
	
	"SMTP_SETTINGS"				=> "Электронная почта / SMTP",
	"SMTP_SETTINGS_DESC"		=> "Настройте SMTP для исходящей почты. Оставьте отключённым, чтобы использовать стандартную функцию PHP mail() на сервере.",
	
	"SMTP_ENABLE"				=> "Включить SMTP",
	...
	"SMTP_PASS_PLACEHOLDER"		=> "(без изменений)",
	"SMTP_FROM_EMAIL"			=> "E-mail отправителя",
	"SMTP_FROM_NAME"			=> "Имя отправителя",
	"SMTP_TEST_LABEL"			=> "Проверить соединение",
	"SMTP_TEST_BTN"				=> "Отправить тестовое письмо",
	"SMTP_TEST_SENDING"			=> "Отправка...",
	
	"SMTP_VERIFY_PEER"			=> "Проверять SSL-сертификат",
	"SMTP_VERIFY_PEER_DESC"		=> "Отключайте только для локальной разработки с самоподписанными сертификатами. На рабочих серверах всегда оставляйте включённым.",
	
	"SMTP_TEST_ERROR"			=> "Ошибка запроса",
	"SMTP_TEST_ERROR_CSRF"		=> "Ошибка проверки безопасности. Перезагрузите страницу и попробуйте снова.",
	"SMTP_TEST_NOT_CONFIGURED"	=> "SMTP не включён. Сначала сохраните настройки.",
	"SMTP_TEST_NO_RECIPIENT"	=> "Для вашей учётной записи не найден действительный адрес электронной почты.",
	"SMTP_TEST_SUBJECT"			=> "Тест SMTP GetSimple CMS CE",
	"SMTP_TEST_BODY"			=> "Это тестовое письмо от GetSimple CMS CE. <br>Если вы его получили, значит настройки SMTP работают корректно.",
	"SMTP_TEST_SUCCESS"			=> "Тестовое письмо отправлено на %s",
	"SMTP_TEST_FAILED"			=> "Отправка не удалась. Проверьте отладочный вывод ниже для получения подробностей.",
