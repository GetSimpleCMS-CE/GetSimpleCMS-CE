...
$i18n = [
	...
	***********************************************************************************/
	...
	"Invalid_already_used"      => "رابط إعادة التعيين غير صالح أو تم استخدامه بالفعل.",
	"must_be_8_characters"      => "يجب أن تتكون كلمة المرور من 8 أحرف على الأقل.",
	"Passwords_do_not_match"    => "كلمتا المرور غير متطابقتين.",
	"Enter_and_confirm"         => "أدخل كلمة المرور الجديدة وأكدها.",
	"New_Password"              => "كلمة المرور الجديدة",
