...
"API_CONFIRM" 			=> "ARE YOU SURE?",
	...
	// salt-shaker
	"Security_Generator" 	=> 'CEセキュリティソルト/ハッシュ生成ツール',
	"More_info" 			=> '詳細情報はこちら',
	"Wiki" 					=> 'Wiki',
	"Security_Notice" 		=> 'セキュリティ通知',
	"Tokens_are_never" 		=> 'トークンは表示されず、処理後すぐに消去されます。',
	"Password_Hash" 		=> 'パスワードハッシュ',
	"Custom_Salt_Hash" 		=> 'カスタムソルトハッシュ',
	"Password_Hashing" 		=> 'パスワードハッシュ化',
	"Used_to_enhance" 		=> 'ユーザーパスワードのセキュリティを強化するために使用されます。追加後、すべてのパスワードをリセットする必要があります。',
	"Password_Token" 		=> 'パスワードトークン',
	"Any_word" 				=> '任意の単語を選択...',
	"Random_string" 		=> '文字や記号を含むランダムな文字列...',
	"System_Salt" 			=> 'システムソルト',
	"Generate" 				=> '生成',
	"Security_Hashing" 		=> 'セキュリティハッシュ化',
	"enhance_system_wide" 	=> 'システム全体のセキュリティを強化するために使用されます。以下を含みます:',
	"temporary_files" 		=> 'クッキー/一時ファイル、セッションリセット、CSRF保護、ファイルアップロードなど',
	"Input_Token" 			=> '入力トークン',
	"Application_Salt" 		=> 'アプリケーションソルト',
	"Generate_Hashes" 		=> 'ハッシュを生成',
	"Password_Hash_Results" => 'パスワードハッシュ結果',
	"hidden" 				=> '非表示',
	"SHA1_of_Salt" 			=> 'ソルトのSHA1',
	"Your_Hash" 			=> 'あなたの\'GSLOGINSALT\'ハッシュ',
	"hash_copied" 			=> 'ハッシュをコピーしました！',
	"Remain_logged" 		=> '管理者アカウントにログインしたままにします。',
	"Add_hash_GSLOGINSALT" 	=> '新しいハッシュをgsconfig.phpの\'GSLOGINSALT\'フィールドに追加します。',
	"Update_all" 			=> 'すべてのユーザーパスワードを更新します。',
	"Custom_Salt" 			=> 'カスタムソルトハッシュ結果',
	"SHA1_of_Application" 	=> 'アプリケーションソルトのSHA1',
	"Your_Custome_Hash" 	=> 'あなたの\'GSUSECUSTOMSALT\'ハッシュ',
