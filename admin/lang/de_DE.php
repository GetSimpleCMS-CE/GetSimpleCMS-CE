...
$i18n = [
	...
	"SECURITY"				=>	"Sicherheit",
	"HTACCESS_TEST_EXPLANATION"	=>	"Dieser Test überprüft, ob sensible Verzeichnisse tatsächlich geschützt sind, indem versucht wird, über HTTP auf sie zuzugreifen. Dadurch wird sichergestellt, dass die .htaccess-Dateien korrekt funktionieren.",
	"CRITICAL_SECURITY_RISK"	=>	"KRITISCHES SICHERHEITSRISIKO",
	"CANNOT_VERIFY"			=>	"Kann nicht überprüft werden",
	"CANNOT_TEST"			=>	"Kann nicht getestet werden",
	"APPLICATION_LEVEL_PROTECTION"	=>	"Schutz auf Anwendungsebene (index.php)",
	"DEFENSE_IN_DEPTH" 		=>	"Tiefenverteidigung",
	"INDEX_PHP_EXPLANATION"	=>	"Diese Schutzdateien bieten Sicherheit auf Anwendungsebene, die auch dann funktioniert, wenn .htaccess deaktiviert ist. Dies ist Ihre primäre Verteidigung gegen unbefugten Zugriff.",
	"INDEX_PHP_RECOMMENDATION"	=>	"Platzieren Sie die index.php-Schutzdateien in sensiblen Verzeichnissen für eine Tiefenverteidigung",
	"RECOMMENDATION"		=>	"Empfehlung",
	"CRITICAL"				=>	"KRITISCH",
	"EFFECTIVENESS"			=>	"Wirksamkeit",
	"PLACE_INDEX"			=>	"Platzieren Sie die bereitgestellten index.php-Dateien in",
	"FILES_PROVIDE"			=>	"Diese Dateien bieten Tiefenverteidigungsschutz, selbst wenn .htaccess fehlschlägt.",
